...
public class Tour {
	...
	public void deplacerUnites(){
		...
		System.out.println("");
		System.out.println("Choisissez un territoire de départ :");
		int choix = scanner.nextInt();
		...
		System.out.println("");
		System.out.println("selectionnez un territoire adjascent où vous déplacer.");
		System.out.println("");
	...
	private void bataille(Territoire depart , Territoire destination) {
		...
		System.out.println("selectionnez des unités pour attaquer :");
